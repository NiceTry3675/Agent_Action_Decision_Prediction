...
| 2026-07-04 | M4: xlm-r-large len448 focal, int8 + 12 val-tuned rules, no sparse (`m4_large448_s42.zip`, `...m4_large_len448_focal_ep5_replay_last1_s42_valmo`) | 0.767660 | pending | | best fixed instance to date (encoder 2stage 0.756718, rules +0.011 val-tuned → heavy Public discount expected). Base-derived transfer line projects encoder-only ~0.749; rules maybe +0.002-0.004. int8 storage (1120→562 MB); sparse deferred to VM retune (focal448 rehearsal showed sparse ≈ +0.0005) |
